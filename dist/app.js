		...
		var states = [
			...
			},
			{
				...
				resolve: {
					...
					projectsLabel: ["$stateParams", "$rootScope", function($stateParams, $rootScope){
						"ngInject";
			...
			},
			{
				...
				resolve: {
					...
					projectLabel: ["$stateParams", "$rootScope", "$projectService", function($stateParams, $rootScope, $projectService){
						"ngInject";
